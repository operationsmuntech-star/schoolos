...
# Email Configuration - Gmail SMTP (Production) or Console (Development)
if DEBUG:
    ...
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    EMAIL_HOST_USER = 'operations.muntech@gmail.com'
    EMAIL_HOST_PASSWORD = os.getenv('EMAIL_PASSWORD')
    DEFAULT_FROM_EMAIL = 'operations.muntech@gmail.com'

# SMS Gateway Settings
# Provider choices: 'africas-talking', 'twilio', 'console'
...
# Default SMS sender id / from
SMS_FROM = os.getenv('SMS_FROM', 'SchoolSys')
...
SMS_PROVIDER = os.getenv('SMS_PROVIDER', 'africas-talking')  # 'africas-talking', 'twilio'
AFRICAS_TALKING_API_KEY = os.getenv('AFRICAS_TALKING_API_KEY', '')
AFRICAS_TALKING_USERNAME = os.getenv('AFRICAS_TALKING_USERNAME', '')
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID', '')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN', '')
